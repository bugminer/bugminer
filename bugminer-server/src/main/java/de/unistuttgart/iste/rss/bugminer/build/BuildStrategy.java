...
public interface BuildStrategy {
	 ...
	 * @param nodeConnection the node on which the project is checked out
	 ...
	 */
	BuildResult build(Project project, NodeConnection nodeConnection, String rootPath) throws IOException;
}
